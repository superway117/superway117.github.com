    ...
    _init: function() {
        ...
        this.bind( Galleria.DATA, function() {
            ...
            var testHeight = function() {
                console.log("stage height="+self.$( 'stage' ).height());
        ...
        if ( options.swipe ) {
            ...
            (function( images ) {
                ...
                images.bind(ev.start, function(e) {
                    ...
                    console.log("galleria images touchstart");
                    data = getData(e);
                    tid = Utils.timestamp();
            ...
            if ( options.fullscreenDoubleTap ) {
                ...
                this.$( 'stage' ).bind( 'touchstart', (function() {
                    ...
                    return function(e) {
                        ...
                        cx = getData(e).pageX;
                        cy = getData(e).pageY;
                        console.log("galleria touchstart x="+cx+"y="+cy);
    ...
    */
    ...
    show : function( index, rewind, _history ) {
        ...
        if ( this._queue.length > 3 || index === false || ( !this._options.queue && this._queue.stalled ) ) {
            console.log("galleria  show 6 error");
            return;
        }
        ...
        if ( !_history && Galleria.History ) {
            ...
            console.log("galleria  show 6 error 2");
            return;
        }
    ...
    _show : function() {
        ...
        if ( !data ) {
            console.log("galleria _show no data");
            return;
        }
        ...
        var complete = (function( data, next, active, queue, thumb ) {
            ...
            return function() {
                ...
                var win;
                console.log("enter _show complete");
                ...
                // trigger IMAGE event
                console.log("trigger image event");
                self.trigger({
                    type: Galleria.IMAGE,
                    index: queue.index,
        ...
        if ( this._options.preload ) {
            ...
            } catch(e) {console.log("catch exception in _show");}
        }
    ...
    _playCheck : function() {
        ...
        if ( this._playing ) {
            ...
            var fn = function() {
                ...
                //console.log("_playCheck _playing="+self._playing);
